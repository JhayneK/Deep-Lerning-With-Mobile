...
images=glob.glob(os.path.join('C:\\Users\\\Jhayne\\\OneDrive\\Área de Trabalho\\IA Reconhecimento Facial\\Driver-Drowsiness-Detection\\train\\dataset','*.jpg'))

# SPLITTING DATASET INTO TRAIN AND TEST SET
train_list, test_list=train_test_split(images,test_size=0.2,shuffle=True)
